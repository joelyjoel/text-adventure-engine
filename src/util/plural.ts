 ...
 */
export function toPlural(singularNoun:string):string {
...
/**
  ...
  */
export function toSingular(pluralNoun:string):string|null {
...
const irregularInverted:{[key: string]: string} = {}
for(let singular in irregular) {
  const plural:string = irregular[singular] 
